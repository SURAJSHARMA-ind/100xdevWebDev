...
router.post('/signup', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, email, userSchema, user_input, validateData, hashedpassword, response;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                validateData = userSchema.parse(user_input);
                return [4 /*yield*/, bcrypt_1.default.hash(validateData.password, 10)];
            case 1:
                hashedpassword = _b.sent();
                if (!validateData) return [3 /*break*/, 3];
                return [4 /*yield*/, client.users.create({
                        data: {
