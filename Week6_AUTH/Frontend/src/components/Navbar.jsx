            ...
            <div className='flex justify-between w-[74%] items-center'>
                ...
                </Link>
                {
                    !loginState ?
                        ...
                        <div className='flex flex-row gap-2 m-2'>
                            <button onClick={logouthandler} className={`  bg-gradient-to-r from-blue-500 to-blue-600  h-10 p-2 shadow-slate-50  text-white  text-sm w-16 hover:from-blue-600 hover:to-blue-700 rounded-md`}>Logout</button>
                        </div>
                }
            </div>
        </div>
